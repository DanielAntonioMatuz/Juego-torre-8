...
//Hash representando los nombre los trigger del animator del panda
    private int animatorMuerteTrigger= Animator.StringToHash("TCaer");
    private int animatorComerTrigger= Animator.StringToHash("TExplotar");
    private int animatorGolpeTrigger= Animator.StringToHash("TGolpe");
